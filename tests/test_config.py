...
def test_config_paths_success(mock_home, mock_mkdir):
    ...
    assert src.config.DEFAULT_PAGES_DIR == str(expected_app_data_dir / "downloaded_pages")
    assert src.config.DEFAULT_SPREADS_DIR == str(expected_app_data_dir / "final_spreads")
...
def test_config_paths_error_on_home(mock_home):
    ...
    assert src.config.DEFAULT_PAGES_DIR == str(expected_pages_path)
    assert src.config.DEFAULT_SPREADS_DIR == str(expected_spreads_path)
